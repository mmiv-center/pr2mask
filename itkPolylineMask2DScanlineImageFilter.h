 ...
 *
 *=========================================================================*/
#ifndef itkPolylineMask2DScanlineImageFilter_h
#define itkPolylineMask2DScanlineImageFilter_h
...
namespace itk {
/**
 *\class PolylineMask2DScanlineImageFilter
...
class ITK_TEMPLATE_EXPORT PolylineMask2DScanlineImageFilter : public ImageToImageFilter<TInputImage, TOutputImage> {
public:
  ITK_DISALLOW_COPY_AND_MOVE(PolylineMask2DScanlineImageFilter);

  /** Standard class type aliases. */
  using Self = PolylineMask2DScanlineImageFilter;
  ...
  itkTypeMacro(PolylineMask2DScanlineImageFilter, ImageToImageFilter);
...
protected:
  PolylineMask2DScanlineImageFilter();
  ~PolylineMask2DScanlineImageFilter() override = default;
...
#include "itkPolylineMask2DScanlineImageFilter.hxx"
#endif
